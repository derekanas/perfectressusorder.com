...
<meta name="viewport" content="width=device-width, initial-scale=0.3">
  ...
  <body>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">Perfectress Connections - Perfectress Remy Cuticle Hair P70
      ...
      <div class="panel-body">
        <form method="post" id="addtocartform" action="p70-transformation-connections-product.php?action=add&code=<?php echo "RRPFN-PSM" ?>">
