...
<!-- <meta name="viewport" content="width=device-width, initial-scale=0.3"> -->
  ...
  <body>
    ...
    <h4>Please check your complete order before finalizing it below.</h4>
    </div>
    ...
    <div style="border:1px solid #EAE8E8">
    ...
    <div style="margin-top:20px;">
      <div class="col-xs-12" style="padding:20px;border:1px solid #EAE8E8;">
        <div class="row">
         <div class="col-xs-3">
      ...
      <button type="submit" class="btn btn-info">BACK TO ORDER</button>
      <a href="send-contact.php" class="btn btn-default btn-center" role="button">CONFIRM ORDER</a>
      </div>
    </form>
    ...
    <div class="col-xs-4 welcome-note" style="margin-right:-15px;">
    ...
    <div class="row">
      <div class="form-group">
        <a href="order-details.php" class="btn btn-info btn-default btn-center" role="button" style="background-color:#803680;width:100%;">ORDER MORE</a>
