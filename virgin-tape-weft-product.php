...
<meta name="viewport" content="width=device-width, initial-scale=0.3">
  ...
  <body>
    ...
    <div class="panel panel-default">
      <div class="panel-heading"> Perfectress Tape Weft - Perfectress Pure Virgin Hair
      ...
      <div class="panel-body">
        <form method="post" id="addtocartform" action="virgin-tape-weft-product.php?action=add&code=<?php echo "PRVN-PTW" ?>">
    ...
    <!-- <p style="font-size:12px;text-align: left;padding-left: 45px; ">*example shown is based on natural dark color</p> -->
      ...
      <div class="col-xs-7" style="margin-left:45px;padding-top:35px;width:350px;">
         ...
         <!--RADIO 1-->
      <div class="box">
    <input type="radio" class="radio_item" value="#  NC" onClick="CB2(this.value);" name="item-colour" id="colour1" checked required>
