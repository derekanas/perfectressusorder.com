...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <form method="post" id="addtocartform" name="addtocartform" action="natural-color.php?action=add&code=<?php echo "PRVN-MTW" ?>" onsubmit="return validateForm()" rel="external" data-ajax="false">
        <div class="ui-grid-a">
              <div class="ui-block-a in-between-spacing">
                ...
                <input type='text' name='quantity' value='1' min='1' class='qty qty-addtocart qty-display-box' data-role="none" />
