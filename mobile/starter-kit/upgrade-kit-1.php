...
if (isset($_POST['addtocart'])){
	...
	//if(isset($_POST['starter-kit'])){
		...
		$itemtool = "Up Grade Kit (Tape Weft Start Kit to Deluxe Kit)";//$_POST['starter-kit'];
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <h3><u>UPGRADE KIT<br>(TAPE WEFT START KIT TO DELUXE KIT)</u></h3>
        </center>
        
        <p>Contents:<br>Transformer C, Reformer, Connector, Connector Loops, Tool Belt, Deluxe Aluminum Case</p>
        
        <form method="post" id="addtocartform" action="upgrade-kit-1.php?action=add&code=<?php echo "KIT" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
