...
if (isset($_POST['addtocart'])){
	...
	//if(isset($_POST['starter-kit'])){
		...
		$itemtool = "Up Grade Kit (Transformation Connections Start Kit to Deluxe Kit)";//$_POST['starter-kit'];
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <h3><u>UPGRADE KIT<br>(TRANSFORMATION CONNECTIONS START KIT TO DELUXE KIT)</u></h3>
        </center>
        
        <p>Contents:<br>Tape Pressing Tool, Tape Removing Tool, Removing Mats, Precut Adhesive Tapes, Prefabricated Adhersive Tapes, Tool Belt, Deluxe Aluminum Case</p>
        
        <form method="post" id="addtocartform" action="upgrade-kit2.php?action=add&code=<?php echo "KIT" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
        ...
        <a href="starter-kit.php" rel="external" class="ui-btn ui-corner-all btn-grey">SELECT DIFFERENT STARTER KIT</a>
