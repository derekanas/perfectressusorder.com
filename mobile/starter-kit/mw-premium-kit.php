...
if (isset($_POST['addtocart'])){
	...
	//if(isset($_POST['starter-kit'])){
		...
		$itemtool = "Multi Weft Premium Kit";//$_POST['starter-kit'];
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <h3><u>MULTI WEFT PREMIUM KIT</u></h3>
        </center>
        
        <p>Contents:<br>Adaptability Ring, Transformer V, Reformer, Hair Pulling Loops, Hair Drawing Tool, Connection Points, Perfect Clips, Aluminum Case</p>
        
        <form method="post" id="addtocartform" action="mw-premium-kit.php?action=add&code=<?php echo "KIT" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
