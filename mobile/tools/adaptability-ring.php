...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool1.png" width="250">
        <h3><u>ADAPTABILITY RING</u></h3>
        </center>
        
        
        <form method="post" id="addtocartform" action="adaptability-ring.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
