...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Connector L with 4 spare loops";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool6.png" width="250">
        <h3><u>CONNECTOR L WITH 4 SPARE LOOPS</u></h3>
        </center>
       
        
        <form method="post" id="addtocartform" action="connector-l.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
