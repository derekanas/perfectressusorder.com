...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Hair Pulling Loops (5 pieces)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/hairpulling2.png" width="250">
        <h3><u>HAIR PULLING LOOPS (5 PCS)</u></h3>
        </center>
        
        
        
        
        <form method="post" id="addtocartform" action="hair-pulling.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
