...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Prefab Tapes (50 pre-fab)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool11.png" width="250">
        <h3><u>PREFAB TAPES (50 PRE-FAB)</u></h3>
        </center>
        
       
        
        
        <form method="post" id="addtocartform" action="prefab.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
