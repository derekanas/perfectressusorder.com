...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/transformer-c.jpg" width="250">
        <h3><u>TRANSFORMER C</u></h3>
        </center>
        
        
        
        <form method="post" id="addtocartform" action="transformer-c.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
