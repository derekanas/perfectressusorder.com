...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Removing Mat (20 pieces)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool14.png" width="250">
        <h3><u>REMOVING MAT (20PCS)</u></h3>
        </center>
        
        
        
        
        <form method="post" id="addtocartform" action="removing-mat.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
