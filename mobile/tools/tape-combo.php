...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Tape Combo Pack (50 pre-cut & 25 pre-fab)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool27.jpg" width="250">
        <h3><u>TAPE COMBO PACK (50 PRE-CUT & 25 PRE-FAB)</u></h3>
        </center>
        
        
        
        
        <form method="post" id="addtocartform" action="tape-combo.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
