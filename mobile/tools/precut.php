...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Precut Adhesive Tapes (100 pre-cut)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool10.png" width="450">
        <h3><u>PRECUT ADHESIVE TAPES (100 PRE-CUT)</u></h3>
        </center>
        ...
        <form method="post" id="addtocartform" action="precut.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
