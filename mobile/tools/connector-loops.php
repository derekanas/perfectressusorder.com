...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Connector L Loops (5 pieces)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool7.png" width="250">
        <h3><u>CONNECTOR L LOOPS (5 PIECES)</u></h3>
        </center>
        
        <form method="post" id="addtocartform" action="connector-loops.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
