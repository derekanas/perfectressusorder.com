    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <h2 class="bold purple">Tools</h2>
         ...
         <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool2.png" width="250">
        <h3><u>FLAT BRISTLE BRUSH</u></h3>
        </center>
        
        
        
        <form method="post" id="addtocartform" action="f-bristle-brush.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
