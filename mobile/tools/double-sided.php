...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Double Sided Adhesive Tape (1 Core = 2 Rolls)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool13.png" width="250">
        <h3><u>DOUBLE SIDED ADHESIVE TAPE (1 CORE = 2 ROLLS)</u></h3>
        </center>
        
        <form method="post" id="addtocartform" action="double-sided.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
