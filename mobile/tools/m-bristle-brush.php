...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool3.png" width="250">
        <h3><u>MINI BRISTLE BRUSH</u></h3>
        </center>
        
     
        
        <form method="post" id="addtocartform" action="m-bristle-brush.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
