...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Perfect Clips  - Light Brown  (5 pieces)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool25.jpg" width="250">
        <h3><u>PERFECT CLIPS - LIGHT BROWN (5 PCS)</u></h3>
        </center>
        
        
        
        <form method="post" id="addtocartform" action="clip-lgtbrown.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
