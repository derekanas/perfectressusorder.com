...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Tape Removing Tool (2 pieces)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool9.png" width="250">
        <h3><u>TAPE REMOVING TOOL (2PCS)</u></h3>
        </center>
        
       
        <form method="post" id="addtocartform" action="tape-remove.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
