...
if (isset($_POST['addtocart'])){
	...
	$itemtool = "Connection Points - Blond  (100 pieces)";
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/tools/big/bigtool31.png" width="250">
        <h3><u>CONNECTION POINTS - BLONDE (100 PCS)</u></h3>
        </center>
       
        <form method="post" id="addtocartform" action="conn-blonde.php?action=add&code=<?php echo "TOOLS" ?>" rel="external" data-ajax="false">
        <div class="ui-grid-a">
