...
if (isset($_POST['addtocart1'])){
	...
	header("Location: https://www.perfectressusorder.com/mobile/transformation-conns-purevirgin/pure-virgin-hair-textures.php");
...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <form method="post" id="addtocartform1" name="addtocartform1" action="pure-virgin-hair-length.php?action=add&code=<?php echo "RREN" ?>" onsubmit="return validateForm()"  rel="external" data-ajax="false">
      ...
      <a href="../order-details.php" rel="external" class="ui-btn ui-corner-all btn-grey">GO BACK</a>
        ...
        <br>
        <!--
        <a href="pure-virgin-hair-textures.html" rel="external" class="ui-btn ui-corner-all btn-purple">NEXT ></a>
        -->
      </div><!--end-main-->
