...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <h2 class="bold purple">Perfectress Connections - Perfectress Pure Virgin Hair</h2>
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a" id="ss">
              	<a href="silky-straight.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/pvh-transconn/texture/texture1.png" class="img-autoscale imgspace">
                <h3 class="center">SILKY STRAIGHT<br>SS</h3>
                </a>
              </div>
              
              <div class="ui-block-b" id="nb">
              	<a href="natural-body.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/pvh-transconn/texture/texture2.png" class="img-autoscale imgspace">
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a" id="bw">
              	<a href="body-wave.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/pvh-transconn/texture/texture3.png" class="img-autoscale imgspace">
                <h3 class="center">BODY WAVE<br>BW</h3>
                </a>
              </div>
              
              <div class="ui-block-b" id="fbw">
              	<a href="french-bw.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/pvh-transconn/texture/texture4.png" class="img-autoscale imgspace">
                <h3 class="center">FRENCH BODY WAVE<br>FBW</h3>
                </a>
              </div>
        </div><!--end-grid-a-->
        
        <div class="ui-grid-a">
              <div class="ui-block-a" id="dc">
              	<a href="deep-curl.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/pvh-transconn/texture/texture5.png" class="img-autoscale imgspace">
                <h3 class="center">DEEP CURLY<br>DCL</h3>
                </a>
              </div>
        </div><!--end-grid-a-->
