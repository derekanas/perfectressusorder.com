...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <form method="post" id="addtocartform" name="addtocartform" action="blonde.php?action=add&code=<?php echo "RREN" ?>" onsubmit="return validateForm()" rel="external" data-ajax="false">
        <div class="ui-grid-a">
              <div class="ui-block-a in-between-spacing">
