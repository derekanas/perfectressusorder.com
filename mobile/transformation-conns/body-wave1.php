...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <a href="remy-cuticle-hair-color.html" rel="external" class="ui-btn ui-corner-all btn-purple">SELECT TEXTURE</a>
        <a href="remy-cuticle-hair-textures.html" rel="external" class="ui-btn ui-corner-all btn-grey">SELECT DIFFERENT TEXTURE</a>
        
      </div><!--end-main-->
    
      <div data-role="footer" class="footer">
        <h6>Terms & Conditions&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Logout</h6>
      </div><!--end-footer-->
