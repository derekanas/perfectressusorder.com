...
<div id="container">
    ...
    <div data-role="page">
      ...
      <input type="text" readonly="readonly" name="hair-texture" id="hair-texture" value="<?php echo $texture; ?>" class="grey-border-input"  />
        ...
        <form method="post" id="addtocartform" name="addtocartform" action="pepper-salt.php?action=add&code=<?php echo "TW" ?>" onsubmit="return validateForm()" rel="external" data-ajax="false">
        <div class="ui-grid-a">
              <div class="ui-block-a in-between-spacing">
