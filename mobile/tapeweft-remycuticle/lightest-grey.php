...
<div id="container">
    ...
    <div data-role="page">
      ...
      <input type="text" readonly="readonly" name="hair-texture" id="hair-texture" value="<?php echo $texture; ?>" class="grey-border-input"  />
        ...
        <img src="https://www.perfectressusorder.com/img/rren-transconn/color/big/56-big.jpg" width="250" height="250">
        <h3><u>LIGHTEST GREY<br>#56</u></h3>
        </center>
        
        <form method="post" id="addtocartform" name="addtocartform" action="lightest-grey.php?action=add&code=<?php echo "RREN-PTW" ?>" onsubmit="return validateForm()" rel="external" data-ajax="false">
        <div class="ui-grid-a">
              <div class="ui-block-a in-between-spacing">
