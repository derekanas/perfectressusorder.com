    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <p style="font-size:12px;">Color pictures are for reference only which might slightly different based on different mobile setting</p>
         <img src="https://www.perfectressusorder.com/img/rren-transconn/color/big/bigcolor17.png" width="250" height="250">
        <h3><u>LIGHT ASH BROWN<br>#18</u></h3>
        </center>
        
        <form method="post" id="addtocartform" name="addtocartform" action="lgt-ash-bwn.php?action=add&code=<?php echo "RREN-PTW" ?>" onsubmit="return validateForm()" rel="external" data-ajax="false">
        <div class="ui-grid-a">
              <div class="ui-block-a in-between-spacing">
