...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <center><img src="https://www.perfectressusorder.com/img/rren-transconn/texture/big/big-texture1.png" width="250">
        ...
        <a href="remy-cuticle-hair-color.php" rel="external" class="ui-btn ui-corner-all btn-purple">SELECT TEXTURE</a>
        <a href="remy-cuticle-hair-textures.php" rel="external" class="ui-btn ui-corner-all btn-grey">SELECT DIFFERENT TEXTURE</a>
