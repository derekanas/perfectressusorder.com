...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <h2 class="bold purple">Perfectress Connections - Perfectress Remy Cuticle Hair P70</h2>
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a">
              	<a href="maroon.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor1.png" class="img-autoscale imgspace">
                <h3 class="center">MAROON<br>#F81</h3>
                </a>
              </div>
              
              <div class="ui-block-b">
              	<a href="pink.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor2.png" class="img-autoscale imgspace">
                <h3 class="center">PINK<br>#F82</h3>
                </a>
              </div>
        </div><!--end-grid-a-->
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a">
              	<a href="purple.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor3.png" class="img-autoscale imgspace">
                <h3 class="center">PURPLE<br>#F83</h3>
                </a>
              </div>
              
              <div class="ui-block-b">
              	<a href="green.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor4.png" class="img-autoscale imgspace">
                <h3 class="center">GREEN<br>#F84</h3>
                </a>
              </div>
        </div><!--end-grid-a-->
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a">
              	<a href="pastel-blonde.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor5.png" class="img-autoscale imgspace">
                <h3 class="center">PASTEL BLONDE<br>#F85</h3>
                </a>
              </div>
              
              <div class="ui-block-b">
              	<a href="pastel-pink.php" rel="external">
              	<img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor6.png" class="img-autoscale imgspace">
                <h3 class="center">PASTEL PINK<br>#F86</h3>
                </a>
              </div>
        </div><!--end-grid-a-->
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a">
              	<a href="blue.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor7.png" class="img-autoscale imgspace">
                <h3 class="center">BLUE<br>#F87</h3>
                </a>
              </div>
              
              <div class="ui-block-b">
              	<a href="pastel-lilac.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor8.png" class="img-autoscale imgspace">
                <h3 class="center">PASTEL LILAC<br>#F88</h3>
                </a>
              </div>
        </div><!--end-grid-a-->
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a">
              	<a href="red.php" rel="external">
              	<img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor9.png" class="img-autoscale imgspace">
                <h3 class="center">RED<br>#F89</h3>
                </a>
              </div>
        </div><!--end-grid-a-->
