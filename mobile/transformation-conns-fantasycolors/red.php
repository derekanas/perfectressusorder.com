      ...
      <div data-role="main" class="ui-content content">
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a in-between-spacing">
     			...
     			<input type="text" readonl="readonly" name="hair-length" id="hair-length" value="<?php echo $hairlength; ?>" class="grey-border-input">
              </div>
              
              <div class="ui-block-b">
              	<label for="size"><h3>Size</h3></label>
     			<input type="text" readonl="readonly" name="size" id="size" value="<?php echo $hairsize; ?>" class="grey-border-input">
              </div>
        </div><!--end-grid-a-->
        
        <label for="hair-texture"><h3>Hair Texture</h3></label>
    	<input type="text" readonl="readonly" name="hair-texture" id="hair-texture" value="<?php echo $texture; ?>" class="grey-border-input"  />
        </form>
        ...
        <img src="https://www.perfectressusorder.com/img/p70/color/big/bigcolor9.png" width="250" height="250">
        <h3><u>RED<br>#F89</u></h3>
        </center>
        
        <form method="post" id="addtocartform" name="addtocartform" action="red.php?action=add&code=<?php echo "RRPFN-PSM" ?>" onsubmit="return validateForm()" rel="external" data-ajax="false">
        <div class="ui-grid-a">
              <div class="ui-block-a in-between-spacing">
        ...
        <a href="p70-fantasy-color.php" rel="external" class="ui-btn ui-corner-all btn-grey">SELECT DIFFERENT COLOR</a>
