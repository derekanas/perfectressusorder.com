...
if (isset($_POST['addtocart1'])){
	...
	header("Location: https://www.perfectressusorder.com/mobile/transformation-conns-fantasycolors/p70-fantasy-color-textures.php");
...
<!--             	<input type="text" name="input-hair-size" id="hair-size" value="Medium (1 pack - 25pcs)" class="grey-border-input"> -->
