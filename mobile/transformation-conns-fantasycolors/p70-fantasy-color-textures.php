...
<div id="container">
    ...
    <div data-role="page">
      ...
      <div data-role="main" class="ui-content content">
        ...
        <div class="ui-grid-a">
              <div class="ui-block-a">
              	<a href="loose-wavy.php" rel="external">
                <img src="https://www.perfectressusorder.com/img/p70/texture/texture1.png" class="img-autoscale imgspace">
                <h3 class="center">LOOSE WAVY<br>WYL</h3>
                </a>
              </div>
        </div><!--end-grid-a-->
