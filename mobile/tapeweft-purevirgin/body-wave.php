...
$_SESSION['texture'] = "Body Wave" ;// , Natural Body , Body Wave
      ...
      <div data-role="main" class="ui-content content">
        ...
        <div class="ui-grid-a">
              ...
              <div class="ui-block-b">
     			...
     			<input type="text" readonly="readonly" name="size" id="size" value="<?php echo $hairlength; ?>" class="grey-border-input">
              </div>
        </div><!--end-grid-a-->
        </form>
        ...
        <center><img src="https://www.perfectressusorder.com/img/pvh-transconn/texture/big/bigtexture3.png" width="250">
        <h3><u>BODY WAVE<br>BW</u></h3>
        
        
        <h5>*example shown is based on natural dark color</h5>
        </center>
        
        <br>
        
        <a href="pure-virgin-hair-color.php" rel="external" class="ui-btn ui-corner-all btn-purple">SELECT TEXTURE</a>
        <a href="pure-virgin-hair-textures.php" rel="external" class="ui-btn ui-corner-all btn-grey">SELECT DIFFERENT TEXTURE</a>
