...
<!-- <meta name="viewport" content="width=device-width, initial-scale=0.3"> -->
  ...
  <body>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">Perfectress Connection - Perfectress Remy Cuticle Hair
      ...
      <div class="panel-body">
        <form method="post" id="addtocartform" name="addtocartform" action="transformation-product.php?action=add&code=<?php echo "RREN-%" ?>" onsubmit="return validateForm()">
      ...
      <br/>
      <select class="form-control" name="input-hair-size" id="input-hair-size" style="width:60%;" required>
        <option value=''>Please Select</option>
  ...
  <div class="row">
    ...
    <!--RADIO 2-->
    <div class="box">
    <input type="radio" class="radio_item" value="# 138" onClick="CB2(this.value);" name="item-colour" id="colour24">
    <label class="label_item" for="colour24"> <img src="img/rren-transconn/color/color25.png"><p class="text-center radio-text">BURGUNDY #138</p> </label>
    </div>  
    <div class="box">
      <input type="radio" class="radio_item" value="# 612" onClick="CB2(this.value);" name="item-colour" id="colour25">
      <label class="label_item" for="colour25"> <img src="img/rren-transconn/color/color26.png"><p class="text-center radio-text">LIGHT ASH BLONDE #612</p> </label>
    </div>
    ...
    <div class="box">
        <input type="radio" class="radio_item" value="# B9" onClick="CB2(this.value);" name="item-colour" id="colour31">
        <label class="label_item" for="colour31"> <img src="img/rren-transconn/color/color32.png"><p class="text-center radio-text">BLEACHED BLONDE #B9</p> </label>
    </div>
    
    <!--RADIO 2-->
    <div class="box">
    <input type="radio" class="radio_item" value="# B11" onClick="CB2(this.value);" name="item-colour" id="colour32">
    <label class="label_item" for="colour32"> <img src="img/rren-transconn/color/color33.png"><p class="text-center radio-text">BLEACHED MEDIUM BLONDE #B11</p> </label>
    </div>  
    <div class="box">
    ...
    <!--RADIO 2-->
    <div class="box">
    <input type="radio" class="radio_item" value="# 1B/138" onClick="CB2(this.value);" name="item-colour" id="colour34">
    <label class="label_item" for="colour34"> <img src="img/rren-transconn/color/color35.png"><p class="text-center radio-text">OFF BLACK<BR/>/BURGUNDY #1B/138</p> </label>
    </div> 
    <div class="box">
        <input type="radio" class="radio_item" value="# 2R/6" onClick="CB2(this.value);" name="item-colour" id="colour35">
        <label class="label_item" for="colour35"> <img src="img/rren-transconn/color/color36.png"><p class="text-center radio-text">DARKEST BROWN - RED TONE / MEDIUM BROWN #2R/6</p> </label>
    </div>
    
    <!--RADIO 2-->
    <div class="box">
    <input type="radio" class="radio_item" value="# 3/8" onClick="CB2(this.value);" name="item-colour" id="colour36">
    <label class="label_item" for="colour36"> <img src="img/rren-transconn/color/color37.png"><p class="text-center radio-text">DARK BROWN/ CHESTNUT BROWN #3/8</p> </label>
    </div>  

    <div class="box">
        <input type="radio" class="radio_item" value="# 6R/10" onClick="CB2(this.value);" name="item-colour" id="colour37">
        <label class="label_item" for="colour37"> <img src="img/rren-transconn/color/color38.png"><p class="text-center radio-text">MEDIUM BROWN - RED TONE/ LIGHT BROWN #6R/10</p> </label>
    </div>
    ...
    <div class="box">
        <input type="radio" class="radio_item" value="# 12/24" onClick="CB2(this.value);" name="item-colour" id="colour39">
        <label class="label_item" for="colour39"> <img src="img/rren-transconn/color/color40.png"><p class="text-center radio-text">GOLDEN BROWN / GOLDEN BLONDE #12/24</p> </label>
      </div>
    ...
    <div id="input-hair-size_validate" style="color:red;font-weight:bold;"></div>
...
$(document).ready(function() {
    ...
    var rules = {
      ...
      messages: {
        ...
        'input-hair-length':  "Please indicate what hair length",
        'input-hair-size': "Please indicate what hair size",
        'quantity': "The limit that you can order for the orderform is 1 until 100 pieces *"
