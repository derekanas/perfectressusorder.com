...
<meta name="viewport" content="width=device-width, initial-scale=0.3">
  ...
  <body>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">Perfectress Multi Weft - Perfectress Pure Virgin Hair
      ...
      <div class="panel-body">
        <form method="post" id="addtocartform" action="virgin-multi-weft-product.php?action=add&code=<?php echo "PRVN-MTW" ?>">
